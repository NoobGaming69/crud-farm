                    ...
                    <div class="card-body">
                        ...
                        <script type="text/javascript">
                            function validateForm() {
                                ...
                                var b = document.forms["Form"]["tribal_governance"].value;
                                var c = document.forms["Form"]["intertribal_relations"].value;
                        ...
                        <form name="Form" action="code.php" autocomplete="off" onsubmit="return validateForm()" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tribal_governance" placeholder="Enter Tribal Governance" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label> Intertribal Relations </label>
                                <input type="text" name="intertribal_relations" placeholder="Enter Intertribal Relations" class="form-control">
                            </div>

                            <div class="mb-3">
                                <button type="submit" name="save_governance" class="btn btn-primary">Save Governance</button>
                            </div>
                        </form>
                    </div>
                </div>
