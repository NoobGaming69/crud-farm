                    ...
                    <div class="card-body">
                        ...
                        <script type="text/javascript">
                            function validateForm() {
                                ...
                                var b = document.forms["Form"]["usage_name"].value;
                                var c = document.forms["Form"]["description"].value;
                                var d = document.forms["Form"]["image"].value;
                                var e = document.forms["Form"]["usage_example"].value;
                        ...
                        <form name="Form" action="code.php" autocomplete="off" onsubmit="return validateForm()" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="usage_name" placeholder="Enter Usage Name" class="form-control">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="usage_example" placeholder="Enter Usage_example" class="form-control">
                            </div>
                            <div class="mb-3">
                                <button type="submit" name="save_common_usage" class="btn btn-primary">Save Common Usage </button>
                            </div>
                        </form>
                    </div>
                </div>
